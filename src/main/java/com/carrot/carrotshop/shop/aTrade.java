...
public class aTrade extends Shop {
	...
	aTrade(Player player, Location<World> sign) throws ExceptionInInitializerError {
		super(sign);
		String type = "aTrade";
	...
	public boolean trigger(Player player) {
		...
		player.sendMessage(Lang.build(Lang.SHOP_RECAP_TRADE, ImmutableMap.<String, Text>builder()
